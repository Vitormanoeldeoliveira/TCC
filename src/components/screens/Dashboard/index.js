import { Box, Button, Divider, Grid, IconButton, InputAdornment, TextField, Typography, useMediaQuery } from '@mui/material';
...
import { GET_PROFIT } from '../../requires/api.require';
...
import { AppropriationReport } from './report';
...
const BarChartComponent = () => {
    ...
    const openPDF = () => {
        AppropriationReport(data?.getAllProfit)
    }
                                                    ...
                                                    isMobile ? (
                                                        ...
                                                        >
                                                            <Divider
                                                                ...
                                                                flexItem sx={{ backgroundColor: "white", height: "8em", mt: 1 }}
                                                            />
                                                            <IconButton
                                                                onClick={() => openPDF()}
                                                            >
                                                                <img src={pdfIcon} height="60em" />
                                                            </IconButton>
                                                        </Box>
                                                    )
                                                }
